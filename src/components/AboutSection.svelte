...
<section id="about" class="py-16 md:py-24 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
  <div class="mb-12">
    <h2 class="text-title-lg md:text-title-xl font-bold text-foreground mb-8">
      <span class="text-transparent bg-clip-text" style="background-image: linear-gradient(to bottom, transparent 0%, transparent 50%, currentColor 50%, currentColor 100%);">
        ABOUT
      </span>
    </h2>
    ...
    <div class="max-w-2xl">
      <p class="text-body-lg text-text-secondary mb-6 leading-relaxed">
        Welcome to my personal entertainment archive. This collection represents years of consuming and enjoying various forms of media – from animated films and series to manga, anime, and interactive games.
      </p>
      <p class="text-body-lg text-text-secondary mb-6 leading-relaxed">
